...
public class CRC16Util {
    private static final byte[] crc16_tab_h = {(byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0,
    ...
    public static boolean crc16Verify(byte[] data) {
        ...
        //crc校验
        byte crcL = data[data.length - 1];
        byte crcH = data[data.length - 2];

        //获取CRC之外的数据
        byte[] originalByte = Arrays.copyOfRange(data, 0, data.length - 2);
        int crc = calcCrc16(originalByte);
        byte[] crcBytes = ByteUtils.intTo2Byte(crc);
     ...
     * 逆变器的CRC高低位相反
     */
    public static boolean crc16VerifyForModbus(byte[] modbusData) {
        if (modbusData == null || modbusData.length < 2) {
            return false;
        }
        //crc校验
        byte crcL = modbusData[modbusData.length - 2];
        byte crcH = modbusData[modbusData.length - 1];

        //获取CRC之外的数据
        byte[] originalByte = Arrays.copyOfRange(modbusData, 0, modbusData.length - 2);
        int crc = calcCrc16(originalByte);
        byte[] crcBytes = ByteUtils.intTo2Byte(crc);
        return crcBytes[0] == crcH && crcBytes[1] == crcL;
    }
